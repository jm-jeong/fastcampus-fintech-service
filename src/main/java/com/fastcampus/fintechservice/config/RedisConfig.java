...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, Liked> redisTemplateMessage(RedisConnectionFactory connectionFactory) {
        return createRedisTemplate(connectionFactory, Liked.class);
    }
